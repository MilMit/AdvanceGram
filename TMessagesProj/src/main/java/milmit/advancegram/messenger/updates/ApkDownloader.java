...
public class ApkDownloader {
    ...
    public static boolean updateDownloaded() {
        ...
        try {
            ...
            if (data.length() > 0) {
                ...
                Log.e("file_size",String.valueOf(update.file_size));
                Log.e("apkFile",String.valueOf(apkFile().length()));
        ...
        if ((BuildVars.BUILD_VERSION >= AdvanceGramConfig.oldDownloadedVersion || AdvanceGramConfig.oldDownloadedVersion == 0) && isAvailableFile) {
    ...
    public static void downloadAPK(Context context, String link, int version) {
        ...
        if (output.exists())
            output.delete();
        AdvanceGramConfig.saveOldVersion(version);
