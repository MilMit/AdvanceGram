...
public class UpdateSignaling {
    public static void checkWasUpdated() {
        String oldBuildVersion = AdvanceGramConfig.oldBuildVersion;
        ...
        if ((oldBuildVersion != null && oldBuildVersion.equals(AdvanceGramConfig.currentNotificationVersion())) || BuildConfig.DEBUG_PRIVATE_VERSION) {
            return;
        }
