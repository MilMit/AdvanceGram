    ...
    public UpdateCell(Context context) {
        ...
        updateTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TranslateAlert.showAlert(context, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0], ti, false, null, null);
            }
        });
        ...
        descMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TranslateAlert.showAlert(context, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0], de, false, null, null);
            }
        });
        ...
        note.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TranslateAlert.showAlert(context, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0], "Note:" + n, false, null, null);
            }
        });
