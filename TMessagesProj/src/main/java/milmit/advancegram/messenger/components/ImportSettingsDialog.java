...
public class ImportSettingsDialog extends BottomSheet {
    ...
    public ImportSettingsDialog(BaseFragment fragment, MessageObject messageObject) {
        ...
        difference = AdvanceGramConfig.getDifferenceBetweenCurrentConfig(messageObject).size();
        ...
        imageView.setStickerPackName("Polar_Adv");
        ...
        buttonTextView.setOnClickListener(view -> {
            dismiss();
            int differenceUI = AdvanceGramConfig.getDifferenceUI(messageObject);
            AdvanceGramConfig.restoreBackup(messageObject);
            ...
            fragment.getNotificationCenter().postNotificationName(NotificationCenter.mainUserInfoChanged);
            AdvanceGramConfig.doRebuildUIWithDiff(differenceUI, fragment.getParentLayout());
