package milmit.advancegram.messenger.components;
    ...
    public UpdateAlertDialog(LaunchActivity activity, UpdateManager.UpdateAvailable updateAvailable) {
        ...
        updateTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TranslateAlert.showAlert(parentActivity, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0], updateAvailable.title, false, null, null);
            }
        });
        ...
        descMessage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TranslateAlert.showAlert(parentActivity, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0], updateAvailable.desc, false, null, null);
            }
        });
        ...
        note.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TranslateAlert.showAlert(parentActivity, null, null, Translator.getCurrentTranslator().getCurrentTargetLanguage().split("-")[0],"Note:" + updateAvailable.note, false, null, null);
            }
        });
