...
public class BlurIntensityCell extends FrameLayout {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("" + AdvanceGramConfig.blurIntensity, getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        sizeBar.setProgress((AdvanceGramConfig.blurIntensity - startIntensity) / (float) (endIntensity - startIntensity));
    }
