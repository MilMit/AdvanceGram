...
public class DcStyleSelector extends LinearLayout {
    ...
    private void drawStyleSelected(Canvas canvas, int x, int y, int w, int h, int maxW, int maxH, int color) {
        ...
        canvas.save();
        if (AdvanceGramConfig.dcStyleType == 0) {
        ...
        if (AdvanceGramConfig.dcStyleType == 1 || AdvanceGramConfig.dcStyleType == 0) {
        ...
        if (AdvanceGramConfig.dcStyleType == 2 || AdvanceGramConfig.dcStyleType == 0) {
    ...
    public static int getStyleSelected() {
        return AdvanceGramConfig.dcStyleType == 0 ? (AdvanceGramConfig.buttonStyleType == 5 ? 1 : 2) : AdvanceGramConfig.dcStyleType;
    }
