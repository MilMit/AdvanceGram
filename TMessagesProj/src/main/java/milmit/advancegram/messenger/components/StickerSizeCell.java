...
public class StickerSizeCell extends FrameLayout {
    ...
    public StickerSizeCell(Context context, INavigationLayout parentLayout) {
        ...
        sizeBar.setDelegate(new SeekBarView.SeekBarViewDelegate() {
            ...
            public void onSeekBarDrag(boolean stop, float progress) {
                ...
                AdvanceGramConfig.setStickerSize(progressSave);
                onSeek();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(String.valueOf(Math.round(AdvanceGramConfig.stickerSizeStack)), getMeasuredWidth() - AndroidUtilities.dp(39), AndroidUtilities.dp(28), textPaint);
        sizeBar.setProgress((AdvanceGramConfig.stickerSizeStack - startStickerSize) / (float) (endStickerSize - startStickerSize));
    }
