...
object GoogleCloudTranslator : NekoXTranslator {
    ...
    override suspend fun doTranslate(from: String, to: String, query: String): String {
        ...
        if (StrUtil.isBlank(AdvConfig.googleCloudTranslateKey.String())) error("Missing Cloud Translate Key")

        val response = HttpUtil.createPost("https://translation.googleapis.com/language/translate/v2")
                .form("q", query)
                .form("target", to)
                .form("format", "text")
                .form("key", AdvConfig.googleCloudTranslateKey.String())
                .apply {
