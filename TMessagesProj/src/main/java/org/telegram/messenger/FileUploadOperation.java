    ...
    private void startUploadRequest() {
        ...
        try {
            ...
            if (stream == null) {
                ...
                uploadChunkSize = (int) Math.max(slowNetwork ? minUploadChunkSlowNetworkSize : AdvanceGramConfig.uploadSpeedBoost ? minUploadChunkSizeBoost : minUploadChunkSize, (totalFileSize + 1024L * maxUploadParts - 1) / (1024L * maxUploadParts));
