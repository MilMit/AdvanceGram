...
import milmit.advancegram.messenger.proxy.ProxyManager;
...
import milmit.advancegram.messenger.proxy.tcp2ws.WsLoader;
...
public class SharedConfig {
    ...
    public static class ProxyInfo implements Comparable<ProxyInfo> {
        ...
        public String getTitle() {
            ...
            if (StrUtil.isBlank(getRemarks())) {
                if (subId != 0L) {
                    builder.append("MilMit Internal Proxy");
                }else {
                    builder.append(getAddress());
                }
            } else {
                if (getRemarks().equals(" NekoX Public Proxy")){
                    builder.append("Adv Public Proxy");
                }else if (getRemarks().equals("NekoX Public Proxy")){
                    builder.append("Adv Public Proxy");
                }else{
    ...
    public static void loadProxyList() {
        ...
        File proxyListFile = new File(ApplicationLoader.applicationContext.getFilesDir().getParentFile(), "advgram/proxy_list.json");
        boolean error = false;
